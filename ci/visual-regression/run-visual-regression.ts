...
// The worker is externally maintained by Cloudflare; its implementation and
// deployment are intentionally not part of this fork. The URL is public, and
// the real protection is SCREENSHOT_API_KEY.
const WORKER_URL =
