...
> & {
  ...
  DANGEROUS_style?: JSX.IntrinsicElements["span"]["style"];
};
...
export function Text<Variant extends TextVariant = "body">({
  ...
  // Rendered via createElement: the dynamic `Component` tag is a union of
  // string literals, which JSX cannot type-check as a single tag. The `ref`
  // prop flows through Octane's ref-as-prop model for host elements.
