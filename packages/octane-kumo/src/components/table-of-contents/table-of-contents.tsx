...
export type TableOfContentsTitleProps = JSX.IntrinsicElements["p"];
...
export type TableOfContentsListProps = JSX.IntrinsicElements["ul"];
...
> & {
   ...
   * framework routers (e.g., an Octane `<Link>`).
...
export type TableOfContentsGroupProps = Omit<
 ...
 * is left to the consumer — pair with `useTableOfContentsActiveId`.
 *
 * @example
 * ```tsx
 * <TableOfContents>
