...
type NativeButtonStyle = Exclude<
  JSX.IntrinsicElements["button"]["style"],
  string | undefined
>;
type BannerActionAccentStyle = NativeButtonStyle &
  Record<`--${string}`, string>;

function bannerActionAccentVars(accent: string): BannerActionAccentStyle {
  return {
